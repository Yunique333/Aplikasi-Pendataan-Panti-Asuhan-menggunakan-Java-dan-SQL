 ...
 * @author User
 */
public class EditPegawai extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Form Edit Pegawai");
    ...
    private void tmblEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tmblEditActionPerformed
        ...
        try{
            int index = DataPegawai.tabel_data_pegawai.getSelectedRow();
            TableModel  model= DataPegawai.tabel_data_pegawai.getModel();
            ...
            String sql ="UPDATE `tabel_pegawai` SET `nama`='%s',`nip`='%s',`jabatan`='%s' WHERE `nama`='%s'";
            sql = String.format(sql,nama.getText(),nip.getText(),jabatan.getText(),nm);
